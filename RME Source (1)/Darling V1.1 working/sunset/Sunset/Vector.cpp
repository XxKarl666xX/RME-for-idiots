...
color colorBackground = color(0, 0, 0, 190);
color colorGrey = color(90, 90, 90, 255);

color colorScrollbar = color(201, 12, 2, 255);

color colorMainMenuFade = color(255, 0, 0, 190);

//Visual colors
color colorEnemy = color(255, 0, 0, 255);
color colorFriendly = color(0, 255, 0, 255);
color colorWallbangable = color(255, 100, 0, 255);
color colorVisible = color(255, 255, 0, 255);
color colorPrioritized = color(0, 255, 255, 255);
color colorWhitelisted = color(255, 255, 255, 255);